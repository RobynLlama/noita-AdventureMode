...
function init(entity_id)
	...
	if (potion_material.icon) then
		--Nonsense, but do it
		ComponentSetValue2(EntityGetFirstComponentIncludingDisabled(entity_id, "SpriteComponent"), "image_file",
			potion_material.icon)
		ComponentSetValue2(EntityGetFirstComponentIncludingDisabled(entity_id, "PhysicsImageShapeComponent"),
			"image_file", potion_material.icon)
		ComponentSetValue2(EntityGetFirstComponentIncludingDisabled(entity_id, "ItemComponent"), "ui_sprite",
			potion_material.icon)
	end
