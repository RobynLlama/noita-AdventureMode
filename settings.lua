			...
			},
			{
				...
				settings = {
					...
					},
					{
						...
						value_default = "40",
						values = { { "0", "Starving [0%]" }, { "20", "Meagre [20%]" }, { "40", "Satiated [40%]" },
							{ "60", "Pleasantly Full [60%]" }, { "80", "Well-Fed [80%]" },
							{ "100", "Fit To Burst [100%]" } },
						scope = MOD_SETTING_SCOPE_NEW_GAME,
					},
					{
						ui_fn = mod_setting_vertical_spacing,
